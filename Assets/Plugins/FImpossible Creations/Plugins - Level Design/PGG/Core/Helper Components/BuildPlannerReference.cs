...
namespace FIMSpace.Generating
{
    ...
    public class BuildPlannerReferenceEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Just debugging examples test for internal variables
            //if ( Get.Planner)
            //{
            //    var internalVariable = Get.Planner.GetInternalValueVariable("Connection", "");
            //    if ( internalVariable != null )
            //    {
            //        UnityEditor.EditorGUILayout.LabelField("Internal Var = " + internalVariable.GetValue());

            //        var oRef = Get.ParentExecutor.GetPlannerReferenceByID(internalVariable.GetVector3Value());
                    
            //        if (oRef)
            //        {
            //            UnityEditor.EditorGUILayout.LabelField("Jest = " + oRef.name);
            //        }
            //    }
            //}
