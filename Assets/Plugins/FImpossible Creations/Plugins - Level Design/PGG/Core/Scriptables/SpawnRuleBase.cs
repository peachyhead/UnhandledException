...
namespace FIMSpace.Generating
{
    ...
    public abstract partial class SpawnRuleBase : ScriptableObject
    {
        ...
        public virtual bool AllowDuplicate() { return true; }
        ...
        [NonSerialized] internal Vector2 _editor_scroll = Vector2.zero;
        ...
        /// <summary> [Base is empty] Executed when all rules was allready executed and all commands execution compleates </summary>
        public virtual void CommandOnAfterAllCommandsCall(FGenGraph<FieldCell, FGenPoint> grid, FieldModification modificator, FieldSetup preset, SpawnInstruction guide)
        { }
        ...
        public void SetOwner(FieldSpawner spawner)
        {
        ...
        public virtual bool _CopyPasteSupported() { return true; }
        /// <summary> Override _CopyPasteSupported to modify copy-paste feature </summary>
        public virtual void PasteOtherProperties(SpawnRuleBase spawnRuleBase, bool force = false)
        {
#if UNITY_EDITOR
