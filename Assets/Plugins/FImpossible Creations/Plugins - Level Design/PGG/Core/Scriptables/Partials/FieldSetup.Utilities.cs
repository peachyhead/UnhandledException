...
namespace FIMSpace.Generating
{
    public partial class FieldSetup : ScriptableObject
    {
        ...
        public FieldVariable GetVariable(string name)
        {
            for (int i = 0; i < Variables.Count; i++)
        ...
        public bool SetVariable(string name, float value)
        {
            for (int i = 0; i < Variables.Count; i++)
        ...
        public void SetTemporaryInjections(List<InjectionSetup> injectMods)
        {
        ...
        public void SetTemporaryInjections(List<FieldModification> injectMods, InjectionSetup.EGridCall call = InjectionSetup.EGridCall.Post)
        {
            SaveCurrentVariablesState();
            temporaryInjections = new List<InjectionSetup>();
        ...
        public void ClearTemporaryInjections()
        {
