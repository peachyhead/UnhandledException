...
namespace FIMSpace.Generating
{
    ...
    public class GeneratingPreparation
    {
        ...
        public void RunPostCellsRefill()
        {
            if (CellInstructions != null)
                for (int i = 0; i < CellInstructions.Count; i++)
        ...
        public void RunTemporaryPreInjections(CellsController generationScheme)
        {
        ...
        public void PrepareScaledGrids()
        {
        ...
        //public void PrepareOptionalCheckers()
        //{
