...
namespace FIMSpace.Generating.Checker
{
    ...
    /// <summary>
    /// DEPRECATED CLASS! USE CheckerField3D instead: Checker Field is collection of multiple Int2D points represented by squares
    /// All positions behaves like children transforms in hierarchy
    /// [Obsolete("CheckerField is deprecated, please use CheckerField3D instead.")]
    /// </summary>
    [System.Serializable]
