...
namespace FIMSpace.Generating.Checker
{
    public partial class CheckerField
    {
        ...
        public Vector2Int GetNearestEdge(Vector2Int localCheckerPos, bool getOutPos = false)
        {
            for (int o = 0; o < 300; o++)
            {
        ...
        /// </summary>
        public void SetAlignNextToPosition(CheckerField other, Vector2Int start, Vector2Int dir, int maxDistance = 30)
        {
        ...
        public List<Vector2Int> FindConnectedShapeOfSize(int size, int radius = 0, bool local = false)
        {
        ...
        public Vector2Int FindEdgeSquareInDirection(Vector2Int start, Vector2Int direction)
        {
