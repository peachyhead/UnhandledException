...
namespace FIMSpace.Generating.Checker
{
    public partial class CheckerField
    {
        ...
        public bool ContainsFully(CheckerField pathCheck)
        {
        ...
        public int GetSizeOnAxis(Vector2 direction)
        {
        ...
        public Bounds GetBoundingBox(float scale = 1f)
        {
        ...
        public Vector2Int FromWorldToGridPos(Vector2Int nearestOwn)
        {
