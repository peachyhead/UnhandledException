...
namespace FIMSpace.Generating
{
    public partial class FieldDesignWindow : EditorWindow
    {
        ...
        [MenuItem("Window/FImpossible Creations/PGG Field Designer (Field Spawner)", false, 49)]
                        ...
                        if (advancedMode)
                        {
                            ...
                            if (GenButtonsFoldout == false)
                            {
                                ...
                                if (usedPainter != null)
                                {
                                    ...
                                    applyChangesOnPainter = EditorGUILayout.Toggle(new GUIContent(PGGUtils.TEX_PGGIcon, "Apply changes on painter"), applyChangesOnPainter, GUILayout.Width(46), GUILayout.Height(18));
                                }
