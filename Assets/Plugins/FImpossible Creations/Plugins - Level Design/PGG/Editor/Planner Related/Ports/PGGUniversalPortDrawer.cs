                ...
                if (PlannerPort != null)
                {
                    if (plPrt.ParentNode != null)
                        if (plPrt.ParentNode._EditorDebugMode)
                            return "Universal port. Input = " + PlannerPort.Variable.GetValue();
                }

                return "Universal port - pin here any port, but beware for type errors";
            }
        }
        ...
        protected override string OutputTooltipText
        {
            get
            {
                if (PlannerPort != null)
                {
                    if (plPrt.ParentNode != null)
                        if (plPrt.ParentNode._EditorDebugMode)
                            return "Universal port. Output = " + PlannerPort.Variable.GetValue();
                }
