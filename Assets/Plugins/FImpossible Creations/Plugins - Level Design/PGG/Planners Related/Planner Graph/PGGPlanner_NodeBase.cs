    ...
    public abstract class PGGPlanner_NodeBase : FGraph_NodeBase
    {
        ...
        public override void OnEndDrag()
        {
            ...
            if (OutputConnections.Count > 0)
            {
                ...
                Rect myBounds = new Rect(NodePosition, _EditorNodeSize * 0.75f);
                Rect oBounds = new Rect(other.NodePosition, other._EditorNodeSize * 0.75f);
            ...
            if (InputConnections.Count > 0)
            {
                ...
                Rect myBounds = new Rect(NodePosition, _EditorNodeSize * 0.7f);
                Rect oBounds = new Rect(other.NodePosition, other._EditorNodeSize * 0.7f);
