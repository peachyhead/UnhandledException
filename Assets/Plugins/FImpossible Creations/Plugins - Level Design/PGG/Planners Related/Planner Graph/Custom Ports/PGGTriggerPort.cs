...
namespace FIMSpace.Graph
{
    ...
    public class PGGTriggerPort : NodePortBase
    {
        ...
        public void Execute( FieldPlanner planner, PlanGenerationPrint print)
        {
            Execute(Connections, planner, print);
        }

        public static void Execute(System.Collections.Generic.List<PortConnection> Connections, FieldPlanner planner, PlanGenerationPrint print)
        {
