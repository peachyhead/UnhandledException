...
namespace FIMSpace.Generating.Planning.PlannerNodes.Logic
{
    ...
    public class PR_EqualIfSwitchExecution : PlannerRuleBase
    {
        ...
        public override void Execute(PlanGenerationPrint print, PlannerResult newResult)
        {
            ...
            if (_EditorDebugMode) UnityEngine.Debug.Log("EXECUTE IF => " + (outputId == 1));

            if (Debugging)
            {
                string connectedNode = FalseOrTrue.GetBaseConnectionPortName();
                if (connectedNode != "") connectedNode = " (connected with '" + connectedNode + "')";
                DebuggingInfo = "Checking Bool Port " + connectedNode + " and Executing Port = " + FalseOrTrue.GetPortValueSafe;
            }
        }
        ...
        public override void Editor_OnAdditionalInspectorGUI()
        {
            ...
            GUILayout.Label("Last Output ID: " + outputId);
        }
