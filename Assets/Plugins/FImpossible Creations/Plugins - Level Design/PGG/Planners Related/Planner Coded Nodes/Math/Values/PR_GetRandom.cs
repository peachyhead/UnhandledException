...
namespace FIMSpace.Generating.Planning.PlannerNodes.Math.Values
{
    ...
    public class PR_GetRandom : PlannerRuleBase
    {
        ...
        public enum EType
        {
            Number, Int, Vector3NoY, Vector3, Vector2, IntInclusive
        }
        ...
        void RefreshValue()
        {
            ...
            else if (RandomOut == EType.IntInclusive)
            {
                RandomF.Value = FGenerators.GetRandom(Mathf.RoundToInt(FromTo.x), Mathf.RoundToInt(FromTo.y+1));
            }
        ...
        public override void Editor_OnNodeBodyGUI(ScriptableObject setup)
        {
            ...
            if (RandomOut == EType.Number || RandomOut == EType.Int || RandomOut == EType.IntInclusive)
            {
