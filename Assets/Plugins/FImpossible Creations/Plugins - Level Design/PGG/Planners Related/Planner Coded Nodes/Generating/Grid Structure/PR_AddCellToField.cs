...
namespace FIMSpace.Generating.Planning.PlannerNodes.Generating
{
    ...
    public class PR_AddCellToField : PlannerRuleBase
    {
        ...
        public override void Execute(PlanGenerationPrint print, PlannerResult newResult)
        {
            ...
            bool applyToPlan = false;
            if (myChe == null && plan != null) { myChe = plan.LatestResult.Checker; applyToPlan = true; }
            if (myChe == null) { if (_EditorDebugMode) UnityEngine.Debug.Log("No Checker"); return; }
            ...
            if (_EditorDebugMode) UnityEngine.Debug.Log("Added " + readPosition);

            if (plan)
                if (applyToPlan)
                    plan.LatestResult.Checker = myChe;
        ...
        public override void Editor_OnAdditionalInspectorGUI()
        {
            ...
            GUILayout.Label("Apply To: " + ApplyTo.GetNumberedIDArrayString());
