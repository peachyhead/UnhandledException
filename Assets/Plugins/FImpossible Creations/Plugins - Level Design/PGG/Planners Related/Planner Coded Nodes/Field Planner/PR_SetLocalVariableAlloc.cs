...
namespace FIMSpace.Generating.Planning.PlannerNodes.Field
{
    ...
    public class PR_SetLocalVariableAlloc : PlannerRuleBase
    {
        ...
        public override void Execute(PlanGenerationPrint print, PlannerResult newResult)
        {
            ...
            Input.Variable.SetValue(Input.GetPortValueSafe);
            ...
            if (_EditorDebugMode) UnityEngine.Debug.Log("Apply " + Input.Variable.GetValue());
        }
        ...
        public override void Editor_OnAdditionalInspectorGUI()
        {
            ...
            GUILayout.Label("Latest Assigned Value: " + Input.Variable.GetValue());
        }
#endif
