...
namespace FIMSpace.Generating.Planning.PlannerNodes.Cells
{
    ...
    public class PR_GetRadomCellIn : PlannerRuleBase
    {
        ...
        public override Vector2 NodeSize { get { return new Vector2(218, _EditorFoldout ? 118 : 98); } }
        ...
        public override void OnStartReadingNode()
        {
            ...
            {
                if (GetCellFrom.IsContaining_Checker)
                {
                ...
                //else
                {
                    planners = GetPlannersFromPort(GetCellFrom, false, false);
                }
            }
            else
            {
                if (CurrentExecutingPlanner != null)
                    checker = CurrentExecutingPlanner.LatestChecker;
            }
            ...
            else
            {
                if (checker != null)
                {
                    ...
                    ChoosedCell.ProvideFullCellData(
                        cell
                        ,checker
                        ,CurrentExecutingPlanner.LatestResult);
                }
            }
