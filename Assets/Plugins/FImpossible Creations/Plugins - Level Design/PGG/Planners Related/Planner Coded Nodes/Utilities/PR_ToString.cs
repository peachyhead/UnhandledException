...
namespace FIMSpace.Generating.Planning.PlannerNodes.Utilities
{
    ...
    public class PR_ToString : PlannerRuleBase
    {
        ...
        public override void OnStartReadingNode()
        {
            ...
            var v = Value.GetPortValueSafe;
            if (v == null) Text.StringVal = "NULL";
            else
            {
                if (v is FieldPlanner) Text.StringVal = (v as FieldPlanner).ArrayNameString;
                else
                    Text.StringVal = v.ToString();
            }
        }
