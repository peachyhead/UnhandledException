...
namespace FIMSpace.Graph
{
    public abstract partial class FGraph_NodeBase : ScriptableObject
    {
        ...
        public Vector2 _EditorNodeSize { get { if ( _EditorCollapse) return new Vector2(CompressedNodeSizeX, 62); else return NodeSize; } }
        public float CompressedNodeSizeX
        { 
            get
            {
                int nameLen = GetDisplayName().Length;
                if (nameLen > 14) return NodeSize.x;
                else return 60 + nameLen * 10;
            } 
        }
        ...
        [HideInInspector]/*[NonSerialized]*/ public bool _EditorCollapse = false;
